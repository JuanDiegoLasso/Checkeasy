...
CREATE TABLE `registro_huesped` (
  ...
  PRIMARY KEY (`identificacion`,`idregistro`)
...
INSERT INTO `registro_huesped` VALUES (5,123,'juan',123),(6,123,'aleja',123),(3,123123,'asdjkakljd',123123),(4,123123,'carlos',1234),(2,12312312,'carlos',123),(6,12312313,'carlos',123123123);
